re2j lesson 002_strip_comments, (c) M. Boerger 2006
...
will have a scanner that filters comments out of c source files but keeps re2j
comments.

The first scanner can be generated with:

  re2j -s -o t.c strip_001.s.re

In the second step we will learn about YYMARKER that stores backtracking 
information.

  re2j -s -0 t.c strip_002.b.re
