/* re2j lesson 002_strip_comments, strip_003.b, (c) M. Boerger 2006 - 2007 */
/*!ignore:re2j
...
- formatting
  . Until now we only used single line expression code and we always had the 
    ...
    code and care for formatting we can no longer rely on re2j. Now we have 
    to indent the rule code ourself. Also we need to take care of the opening
    {. If we keep it on the same line as the rule then re2j will indent it 
