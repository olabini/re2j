...
- basic interface for file reading
  ...
  . As re2j scanners might read more than one character we need to ensure our
    buffer is long enough. We can use re2j to inform about the maximum size 
    by placing a "!max:re2j" comment somewhere. This gets translated to a 
